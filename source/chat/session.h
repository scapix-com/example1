...
// In Java, only the first class in header will be declared public.
// If you need all classes to be public in Java, place them in separate C++ headers.
// For Objective-C, Swift and Python - there is no difference.
